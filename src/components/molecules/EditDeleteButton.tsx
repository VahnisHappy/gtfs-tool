    ...
    return (
        <div className="inline-flex rounded-base shadow-xs -space-x-px" role="group">
            <button
                onClick={onEdit}
                disabled={disabled}
                className={`inline-flex items-center justify-center text-body border border-default bg-neutral-primary-soft hover:bg-neutral-secondary-medium hover:text-heading focus:ring-3 focus:ring-neutral-tertiary-soft font-medium leading-5 rounded-l-md text-sm w-9 h-9 focus:outline-none ${disabled
                        ? 'cursor-not-allowed'
            ...
            <button
                onClick={onDelete}
                disabled={disabled}
                className={`inline-flex items-center justify-center text-body border border-default bg-neutral-primary-soft hover:bg-neutral-secondary-medium hover:text-heading focus:ring-3 focus:ring-neutral-tertiary-soft font-medium leading-5 rounded-r-md text-sm w-9 h-9 focus:outline-none ${disabled
                        ? 'cursor-not-allowed'
